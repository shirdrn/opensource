...
public class LiveRoomOnlineUserCountServiceImpl implements ChatRoomOnlineUserCounterService {

	private static final Log LOG = LogFactory.getLog(LiveRoomOnlineUserCountServiceImpl.class);
